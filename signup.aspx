<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="PharmacyWebsite.signup" %>
...
<body  >
        ...
        <div class="container">
         <form id="form1" runat="server" class="form">
            ...
            <div class="sub-container2-1">
                ...
                <div class="form-container1" onkeydown="return (event.keyCode!=13);">
                    <h1 style="margin-bottom:30px;">Create Account</h1>
                    <asp:TextBox class="txtname" ID="txtname" runat="server" placeholder="Name"
            ...
            onfocus="clearPlaceholder(this);" onblur="setPlaceholder(this);" ></asp:TextBox>
                    <asp:TextBox class="txtpassword" ID="txtpassword" runat="server" TextMode="Password" placeholder="Password (4 to 8 digits)"
            onfocus="clearPlaceholder(this);" onblur="setPlaceholder(this);" ></asp:TextBox>
                    <asp:Button class="btnsignup" ID="btnsignup" runat="server" Text="Sign Up" OnClientClick="if(!logininfo()) return false;" OnClick="btnsignup_Click" />
                </div>
   ...
   <script>
       function logininfo() {
           ...
           var txtnameExists = localStorage.getItem("txtname");
